...
const ContactInfo = ({ containerVariants, itemVariants }) => {
    const contactInfo = [
        {
            id: 'address',
            icon: (
            ...
            title: 'Địa chỉ',
            info: '12 Nguyễn Văn Bảo phường 1, Gò Vấp, Hồ Chí Minh'
        },
        {
            id: 'email',
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-envelope-fill" viewBox="0 0 16 16">
                    <path d="M.05 3.555A2 2 0 0 1 2 2h12a2 2 0 0 1 1.95 1.555L8 8.414.05 3.555ZM0 4.697v7.104l5.803-3.558L0 4.697ZM6.761 8.83l-6.57 4.027A2 2 0 0 0 2 14h12a2 2 0 0 0 1.808-1.144l-6.57-4.027L8 9.586l-1.239-.757Zm4.436-.586L16 11.801V4.697l-5.803 3.546Z"/>
                </svg>
            ),
            title: 'Email',
            info: 'support@solestore.com'
        },
        {
            id: 'phone',
            icon: (
            ...
            title: 'Số điện thoại',
            info: '(+84) 28 3930 5678'
        },
        {
            id: 'hours',
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-clock-fill" viewBox="0 0 16 16">
                    <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8 3.5a.5.5 0 0 0-1 0V9a.5.5 0 0 0 .252.434l3.5 2a.5.5 0 0 0 .496-.868L8 8.71V3.5z"/>
                </svg>
            ),
            title: 'Giờ làm việc',
            info: 'Thứ 2 - Chủ nhật: 9:00 - 21:00'
        }
    ];
                    ...
                    {contactInfo.map(item => (
                        ...
                        >
                            ...
                            <div>
                                ...
                                <p className="text-white-50 mb-0">{item.info}</p>
                            </div>
                        </motion.div>
                    ))}
