...
const WomensSports = () => {
  ...
  // Nếu chỉ số của icon nhỏ hơn phần nguyên của rating, icon đó được hiển thị màu 
  // vàng, ngược lại hiển thị màu xám. Kèm theo đó là số rating được hiển thị bên cạnh
